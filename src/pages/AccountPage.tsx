        ...
        <div className="h-full w-4/5 2xl:w-[65%] flex items-center justify-center">
          <div className="flex flex-col w-96">
            <form onSubmit={handleSubmit}>
              ...
              <h1 className="text-xl md:text-2xl font-bold pb-4 2xl:pb-9">
                Olá {authData.nome}!
              </h1>
              <p className="text-lg pb-4">
                Edite seus dados ou altere sua senha abaixo:
              </p>
              ...
              <input
                placeholder="Mudar a senha é opcional..."
                type="password"
                id="password"
              ...
              <div className="w-full text-right text-lg pt-5">
                <button
                  type="button"
                  className="underline "
                  onClick={() => {
